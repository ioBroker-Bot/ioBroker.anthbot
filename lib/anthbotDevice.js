...
class AnthbotDevice {
    ...
    async createObjects() {
        ...
        const readOnlyStates = [
            ...
            // Schedule
            ['schedule_custom_areas_left_today', 'string', 'list', `List of custom areas left to start today`],
            [
                'schedule_estimated_time_left_todo_today',
                'number',
                'time.span',
    ...
    async checkCustomAreaSchedule() {
        ...
        await this.adapter.setStateChanged(`${this.sn}.schedule_custom_areas_left_today`, {
            val: JSON.stringify(customAreaIdsLeftToday),
            ack: true,
        });
        await this.adapter.setStateChanged(`${this.sn}.schedule_estimated_time_left_todo_today`, {
