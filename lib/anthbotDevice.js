...
class AnthbotDevice {
    ...
    async checkCustomAreaSchedule() {
        ...
        await this.adapter.setStateChanged(`${this.sn}.iob_schedule.custom_areas_left_today`, {
            val: JSON.stringify(customAreaIdsLeftToday),
            ack: true,
        });
        await this.adapter.setStateChanged(`${this.sn}.iob_schedule.estimated_time_left_todo_today`, {
